...
docker exec admin.example.local wp --path=/usr/src/wordpress plugin install gutenberg wp-stateless disable-blogging white-label-cms https://github.com/willopez/fancy-admin-ui/archive/master.zip --activate
